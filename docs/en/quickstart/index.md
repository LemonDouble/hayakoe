...
1. [Installation — CPU vs GPU](./install) — Choose the right installation profile for your environment
2. [First Voice](./first-voice) — Generate and save a wav file with built-in speakers
3. [Speed & Prosody Controls](./parameters) — Understand speed/pitch/prosody parameters
4. [Custom Word Registration](./custom-words) — Fix mispronounced words manually
5. [Sentence-level Streaming](./streaming) — Send the first audio chunk of long texts quickly
6. [Benchmark on Your Machine](./benchmark) — Measure actual performance on your hardware
...
::: info Custom speaker training is in progress
A guide for preparing recordings and training your own speaker is being written.

It will be available in the [Custom Speaker Training](/en/training/) section once ready.
:::
