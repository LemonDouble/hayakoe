...
![HayaKoe 前処理ダッシュボードのメイン画面 — 上部にワークフローガイドとステップごとのカード](/images/preprocess/dashboard-ja.png)
...
![オーディオ抽出ステップ — 上部プログレスバーで1ステップ目がアクティブ、NEXT STEP カードに「抽出実行」ボタン](/images/preprocess/step1-extract-ja.png)
...
![背景音除去ステップ — 2ステップ目がアクティブ、NEXT STEP カードに「背景音除去実行」ボタン](/images/preprocess/step2-separate-ja.png)
...
![VAD セグメンティングステップ — クイック設定と詳細パラメータ入力、「VAD セグメンティング実行」ボタン](/images/preprocess/step3-vad-ja.png)
...
![分類ステップ — セグメントが自動再生され、話者番号キーまたはボタンで割り当て](/images/preprocess/step4-classify-ja.png)
...
![書き起こしステップ — NEXT STEP カードに「書き起こし実行」ボタン](/images/preprocess/step5-transcribe-ja.png)
...
![レビューステップ — セグメント一覧と日本語テキスト編集 UI、上部に「レビュー完了」ボタン](/images/preprocess/step6-review-ja.png)
