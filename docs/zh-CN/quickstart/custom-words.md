...
::: info 已内置约 22 万个英语单词
HayaKoe 在将文本传给 pyopenjtalk **之前**,会将英语单词替换为片假名。

pyopenjtalk 原生字典认识的单词(冠词、缩写、知名品牌等)直接采用其读音,只有不认识的单词才通过内部规范化字典替换。

该回退字典预置了 221,591 个英语单词及其对应片假名,因此 `OpenAI`·`GitHub` 等常见英语专有名词无需调用 `add_word()` 就能自然地朗读。
