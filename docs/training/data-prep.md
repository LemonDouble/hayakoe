...
![HayaKoe 전처리 대시보드 메인 화면 — 상단 워크플로우 가이드와 단계별 카드](/images/preprocess/dashboard-ko.png)
...
![오디오 추출 단계 — 상단 진행 바에서 1단계 활성, NEXT STEP 카드에 '추출 실행' 버튼](/images/preprocess/step1-extract-ko.png)
...
![배경음 제거 단계 — 2단계 활성, NEXT STEP 카드에 '배경음 제거 실행' 버튼](/images/preprocess/step2-separate-ko.png)
...
![VAD 세그먼팅 단계 — 빠른 설정과 세부 파라미터 입력, 'VAD 세그먼팅 실행' 버튼](/images/preprocess/step3-vad-ko.png)
...
![분류 단계 — 세그먼트가 자동 재생되고, 화자 번호 키나 버튼으로 배정](/images/preprocess/step4-classify-ko.png)
...
![전사 단계 — NEXT STEP 카드에 '전사 실행' 버튼](/images/preprocess/step5-transcribe-ko.png)
...
![검토 단계 — 세그먼트 목록과 일본어 텍스트 편집 UI, 상단에 '검토 완료' 버튼](/images/preprocess/step6-review-ko.png)
